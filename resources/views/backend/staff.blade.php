                    ...
                    <div class="modal fade" id="exampleModal" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                ...
                                <input type="hidden" id="saveurl" value="staff/savedata" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <!-- Form Field Start -->
                                                    <div class="mb-3">
                                                        <label for="deg_name" class="form-label">Designation <span style='color:red' title='mandatory feild'>*</span></label>
                                                        <select class="form-select" aria-label="deg_name" id='deg_name' name="deg_name" >
